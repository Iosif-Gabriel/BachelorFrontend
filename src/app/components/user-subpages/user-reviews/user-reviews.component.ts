...
export class UserReviewsComponent implements OnInit {
  ...
  constructor(private sectionService:SectionService,private tokenService:TokenService,private popupService:PopupService,private feedbackService:FeedbackService){
  ...
  ngOnInit(): void {
    this.sectionService.setActiveSection("userRev")
